...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  Future<void> _loadPlaces() async {
    ...
    try {
      ...
      setState(() {
        _places = items.asMap().entries.map<Map<String, dynamic>>((entry) {
          final i = entry.key;
          final p = entry.value;
          final images = [
            AppAssets.pyramids,
  ...
  String _getImage(String title) {
    ...
    if (t.contains('karnak')) return AppAssets.karnak;
    if (t.contains('abu simbel')) return AppAssets.abuSimbel;
    if (t.contains('alexandria')) return AppAssets.alexandria;
    if (t.contains('philae')) return AppAssets.philae;
    if (t.contains('pyramid')) return AppAssets.pyramids;
    if (t.contains('siwa')) return AppAssets.siwa;
    if (t.contains('nile')) return AppAssets.nileSunset;
    if (t.contains('luxor')) return AppAssets.luxorNight;
    if (t.contains('valley')) return AppAssets.valley;
    if (t.contains('museum')) return AppAssets.museum;
    return AppAssets.pyramids; // default
  }
